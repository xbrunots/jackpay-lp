...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden pt-24 pb-16 bg-jockepay-dark">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        {/* Floating elements */}
        <div className="absolute top-1/3 left-1/4 w-80 h-80 bg-jockepay-blue/20 rounded-full filter blur-3xl animate-float"></div>
        ...
        <div className="absolute inset-0 z-0 opacity-20">
          {Array.from({ length: 15 }).map((_, i) => (
            <div 
              key={i}
              className="absolute bg-gradient-to-r from-jockepay-blue/80 to-jockepay-neon/80 h-0.5 rounded-full animate-data-flow"
              style={{
      ...
      <div className="container-custom relative z-10">
        <div className="flex flex-col md:flex-row items-center md:gap-16 lg:gap-24 py-12">
          <div className="w-full md:w-1/2 text-left">
            <div className="inline-flex items-center px-4 py-1.5 mb-8 rounded-full backdrop-blur-sm bg-jockepay-blue/10 border border-jockepay-blue/20 text-jockepay-neon text-sm">
          ...
          <div className="w-full md:w-1/2 relative mt-16 md:mt-0">
            <div className="relative z-10 backdrop-blur-md rounded-2xl bg-black/30 p-1.5 border border-white/20 shadow-xl">
              <div className="bg-jockepay-dark/80 backdrop-blur-sm rounded-xl overflow-hidden">
                {/* Header with dots */}
                <div className="px-4 py-3 border-b border-white/20 flex items-center gap-2">
                  ...
                  <div className="ml-4 text-sm text-white/80 flex-1 text-center">Jockepay Dashboard</div>
                </div>
                
                {/* Dashboard visualization - Melhorado */}
                <div className="p-6">
                  ...
                  <div className="relative h-72">
                    ...
                    <div className="absolute left-20 right-0 top-0 bottom-0">
                      ...
                      <div className="absolute top-1/4 left-0 right-0 h-10 flex items-center">
                        ...
                        <div className="shrink-0 ml-2 px-3 py-1.5 bg-jockepay-success/30 backdrop-blur-sm text-jockepay-success text-xs rounded-lg border border-jockepay-success/40 font-medium flex items-center">
                      ...
                      <div className="absolute top-1/2 left-0 right-0 h-10 flex items-center">
                        ...
                        <div className="shrink-0 ml-2 px-3 py-1.5 bg-jockepay-danger/30 backdrop-blur-sm text-jockepay-danger text-xs rounded-lg border border-jockepay-danger/40 font-medium flex items-center">
                      ...
                      <div className="absolute top-1/2 translate-y-10 left-3/5 right-0 h-10 flex items-center">
                        ...
                        <div className="absolute top-8 left-0 right-0 h-10 flex items-center">
                          ...
                          <div className="shrink-0 ml-2 px-3 py-1.5 bg-jockepay-success/30 backdrop-blur-sm text-jockepay-success text-xs rounded-lg border border-jockepay-success/40 font-medium flex items-center animate-appear" style={{ animationDelay: '1.8s', opacity: 0 }}>
                            <span className="w-2 h-2 bg-jockepay-success rounded-full mr-2"></span>
                            PSP 3 | Aprovado
                          </div>
                        </div>
                      ...
                      <div className="absolute top-3/4 left-0 right-0 h-10 flex items-center">
                        ...
                        <div className="shrink-0 ml-2 px-3 py-1.5 bg-jockepay-warning/30 backdrop-blur-sm text-jockepay-warning text-xs rounded-lg border border-jockepay-warning/40 font-medium flex items-center">
                  ...
                  <div className="grid grid-cols-3 gap-3 mt-6">
                    <div className="backdrop-blur-sm bg-white/10 rounded-xl p-3 text-center border border-white/20 hover:scale-105 transition-transform duration-300">
                      <div className="text-xs text-white/70 mb-1">Sucesso</div>
                      <div className="text-xl font-semibold text-jockepay-success">89.2%</div>
                    </div>
                    <div className="backdrop-blur-sm bg-white/10 rounded-xl p-3 text-center border border-white/20 hover:scale-105 transition-transform duration-300">
                      <div className="text-xs text-white/70 mb-1">Recuperados</div>
                      <div className="text-xl font-semibold text-jockepay-neon">7.5%</div>
                    </div>
                    <div className="backdrop-blur-sm bg-white/10 rounded-xl p-3 text-center border border-white/20 hover:scale-105 transition-transform duration-300">
                      <div className="text-xs text-white/70 mb-1">Economia</div>
            ...
            {/* Decorative elements */}
            <div className="absolute -bottom-12 -right-12 w-32 h-32 bg-jockepay-neon/30 rounded-full blur-2xl"></div>
            <div className="absolute -top-12 -left-12 w-40 h-40 bg-jockepay-blue/20 rounded-full blur-2xl"></div>
          </div>
        </div>
      </div>
    </section>
